package com.ibnsina.utils.dialog;
...
import com.ibnsina.utils.R
import com.ibnsina.utils.base.BaseDialogFragment
...
class MessageDialog() : BaseDialogFragment() {
    ...
    override fun initViews() {
        ...
        val ok = requireView().findViewById<TextView>(R.id.ok)
        val cancel = requireView().findViewById<TextView>(R.id.cancel)
        val title = requireView().findViewById<TextView>(R.id.title)
        val message_container = requireView().findViewById<ScrollView>(R.id.message_container)
        val dialog_card = requireView().findViewById<CardView>(R.id.dialog_card)
        if (isProgress) {
...
//                        super.dismiss();
//                    } catch (e : Exception) {
//                        com.ibnsina.utils.LogE("messageDialog", "${e.message} and isProgress = $isProgress",e);
//                    }
//                }, 200);
//            else super.dismiss();
//        } catch (e : Exception) {
